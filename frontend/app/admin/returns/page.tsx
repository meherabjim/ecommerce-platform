...
export default function AdminReturns(){
  ...
  return <AdminShell>
    <div className="flex flex-wrap items-end justify-between gap-4"><div><p className="text-xs font-black uppercase tracking-[.18em] text-blue-600">After-sales operations</p><h1 className="mt-2 text-4xl font-black">Returns & refunds</h1><p className="mt-2 text-sm text-slate-500">Review requests, receive returned goods and hand refunds to Finance with a clear audit trail.</p></div><Link href="/admin/finance" className="rounded-xl bg-[#1464f4] px-4 py-3 text-sm font-black text-white">Open Finance</Link></div>
